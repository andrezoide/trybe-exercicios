...
// com a classe 'tech';
input.addEventListener("keyup", writeHere);
...
function redirecionar(){
    window.open('https://www.instagram.com/andreluizzzzzzzzz/');
};
...
myWebpage.addEventListener('mouseover', cor)
myWebpage.addEventListener('mouseleave' , some)
function some(event){
